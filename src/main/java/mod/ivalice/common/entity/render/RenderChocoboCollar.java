...
public class RenderChocoboCollar extends RenderLayer<EntityChocobo, ModelChocobo<EntityChocobo>> {
	...
	private static final ResourceLocation TEXTURE1 = new ResourceLocation(MODID, "textures/entity/chocobo_saddle.png");
	// private static final ResourceLocation TEXTURE2 = new ResourceLocation(MODID, "textures/entity/chocochick_saddle.png");
	...
	public RenderChocoboCollar(RenderLayerParent<EntityChocobo, ModelChocobo<EntityChocobo>> p_174533_, EntityModelSet ems) {
		super(p_174533_);
	...
	public void render(PoseStack p_117720_, MultiBufferSource p_117721_, int p_117722_, EntityChocobo p_117723_, float p_117724_, float p_117725_, float p_117726_, float p_117727_, float p_117728_, float p_117729_) {
		if (p_117723_.isTame() && !p_117723_.AnimYoung() && !p_117723_.isInvisible()) {
