...
public class GoalBuildNest extends Goal {
    ...
    public GoalBuildNest(AnimalEntity p_i1619_1_, double p_i1619_2_) {
        this(p_i1619_1_, p_i1619_2_, p_i1619_1_.getClass());
    }

    public GoalBuildNest(AnimalEntity p_i47306_1_, double p_i47306_2_, Class<? extends AnimalEntity> p_i47306_4_) {
